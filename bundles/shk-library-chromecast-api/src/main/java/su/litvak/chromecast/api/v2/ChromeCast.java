...
public class ChromeCast {
    ...
    public void stopApp() throws IOException {
        final Application runningApp = getRunningApp();
        if (runningApp == null) {
    ...
    public void play() throws IOException {
        ...
        final MediaStatus mediaStatus = channel.getMediaStatus(runningApp.transportId);
        if (mediaStatus == null) {
    ...
    public MediaStatus load(final String title, final String thumb, final String url, final String contentType)
        ...
        final Map<String, Object> metadata = new HashMap<String, Object>(2);
        metadata.put("title", title);
        metadata.put("thumb", thumb);
        return channel.load(runningApp.transportId, runningApp.sessionId,
                new Media(url, contentType, null, null, null, metadata, null, null), true, 0d, null);
    }
